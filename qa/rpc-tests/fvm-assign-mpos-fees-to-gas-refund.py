...
class FvmAssignMPoSFeesToGasRefundTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, scriptPubKey=CScript([b"\x04", CScriptNum(40000000), CScriptNum(100000), b"\x00", bytes.fromhex(address), OP_FVMCALL]))]
...
if __name__ == '__main__':
    FvmAssignMPoSFeesToGasRefundTest().main()
