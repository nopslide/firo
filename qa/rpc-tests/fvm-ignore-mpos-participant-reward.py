...
class FvmIgnoreMPOSParticipantRewardTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, scriptPubKey=CScript([b"\x04", CScriptNum(4000000), CScriptNum(100000), b"\x00", hex_str_to_bytes(contract_address), OP_FVMCALL]))]
...
if __name__ == '__main__':
    FvmIgnoreMPOSParticipantRewardTest().main()
