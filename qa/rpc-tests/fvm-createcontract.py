...
class CreatecontractTest(BitcoinTestFramework):
    ...
    def createcontract_with_sender_test(self):
        self.node.importprivkey("UTD3hcSUgX88PB5EtyP85d5YfK1DPVpTvynZYn64y5APn5e1Jm3f")
        self.node.sendtoaddress("TSmfsjbZRZUtAiKQHcNSa6CEAWshB8xuaE", 0.1)
        self.node.generate(1)
        ...
        """
        ret = self.node.createcontract("", 1000000, FVM_MIN_GAS_PRICE_STR, "qabmqZk3re5b9UpUcznxDkCnCsnKdmPktT")
        assert('txid' in ret)
        assert('sender' in ret)
        assert('hash160' in ret)
        contract_address = ret['address']
