...
inline void initState(){
    ...
    globalState = std::unique_ptr<FvmState>(new FvmState(dev::u256(0), FvmState::openDB(dirFvm, hashDB, dev::WithExisting::Trust), dirFvm + "/qtumDB", dev::eth::BaseState::Empty));
