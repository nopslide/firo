...
bool FvmDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule FvmDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule FvmDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
