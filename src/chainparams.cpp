...
static CBlock CreateGenesisBlock(const char *pszTimestamp, const CScript &genesisOutputScript, uint32_t nTime, uint32_t nNonce,
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); //hashStateRoot
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); //hashUTXORoot
    return genesis;
}
